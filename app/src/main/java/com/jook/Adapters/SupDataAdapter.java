...
public class SupDataAdapter extends BaseAdapter
{
    ...
    public SupDataAdapter(Activity activity, ArrayList<HashMap<String, String>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View vi= convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.shop_for_book_view_list_row, null);

        TextView title = (TextView)vi.findViewById(R.id.shop_name);
        TextView ship = (TextView)vi.findViewById(R.id.shop_shiping); // artist name
        TextView price = (TextView)vi.findViewById(R.id.shop_price_for_book); // duration
        ImageView thumb_image =(ImageView)vi.findViewById(R.id.StarForShop); // thumb image
        ...
        title.setText(sup.get(KEY_SHOP_NAME));
        ship.setText(sup.get(KEY_SHOP_SHIP));
        price.setText(sup.get(KEY_SHOP_PRICE));

        switch (sup.get(KEY_SHOP_STAR))
        {
            case "1":
